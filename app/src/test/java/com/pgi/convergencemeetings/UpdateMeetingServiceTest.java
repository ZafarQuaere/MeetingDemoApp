...
/**
 * Created by visheshchandra on 12/29/2017.
 */

@PrepareForTest({PgiWebServiceManager.class, CommonUtils.class})
public class UpdateMeetingServiceTest extends RobolectricTest {
    @Rule
    ...
    private UpdateMeetingService mUpdateMeetingService;
    ...
    public void setup(){
        ...
        mUpdateMeetingService = new UpdateMeetingService(mMeetingRoomPresenter);
    }
    ...
    public void testUpdateMeetingSuccess() throws IOException {
        ...
        mMeetingRoomPresenter.onUpdateMeetingSuccess();
        Mockito.verify(mMeetingRoomPresenter).onUpdateMeetingSuccess();
    }
    ...
    public void testUpdateMeetingError(){
        ...
        meeting.setFavorite(false);
        String desktopMeetingId = "4606";
        mMeetingRoomPresenter.onUpdateMeetingError(Mockito.anyString());
        Mockito.verify(mMeetingRoomPresenter, Mockito.times(1)).onUpdateMeetingError(Mockito.anyString());
    }
}
