package com.pgi.convergence.common.di

import androidx.test.core.app.ApplicationProvider
import com.pgi.convergence.common.features.*
...
//
//	val featureService = FeaturesConfigService()
//	val loggerMock = mockkClass(Logger::class, relaxed = true)
//	val featureServiceMock = mockkClass(FeaturesConfigService::class, relaxed = true)
//	val configAPi = mockkClass(RemoteFeatureConfigAPi::class, relaxed = true)
//
//	val mockSharedConfigData = "{\"app\":{\"agendaEnabled\":true,\"webcamsEnabled\":true,\"callsEnabled\":false," +
//			"\"chatsEnabled\":false,\"homeEnabled\":true,\"voiceMailEnabled\":false,\"joinMeetingAttemptMaxDuration\": 15000}, +" +
//			"\"configurl\":\"https://mobiledev.globalmeet.net\",\"ucaas\":{\"baseUrl\":\"https://crossbar.uc.globalmeet.com/\", +" +
//			"\"calls\":{\"timerInterval\":15},\"voicemail\":{\"timerInterval\":15}}}"
//
//	every {
//		featureServiceMock.getConfig("https://mobiledev.globalmeet.net")
//
//	} returns configAPi.getRemoteConfig()
//
//
//
//	factory {
